...
def get_crt_root(a_list, n_list):
    ...
    return (11 * 13 * 37 * 26 * a_list[0] + 27 * 13 * 37 * 8 * a_list[1]
            + 27 * 11 * 37 * 10 * a_list[2] + 27 * 11 * 13 * 20 * a_list[3]) % n_mul
...
for _ in range(t):
    ...
    a_list = [choose_modulo_prime_power(n, k, 3, 3), choose_modulo_prime(n, k, 11), choose_modulo_prime(n, k, 13),
              choose_modulo_prime(n, k, 37)]
    printf(str(get_crt_root(a_list, n_list)))
    printf('\n')
stdout.flush()